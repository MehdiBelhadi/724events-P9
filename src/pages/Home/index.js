...
import ModalEvent from "../../containers/ModalEvent"; // Importation de modalEvent pour pouvoir l'afficher sur "Notre dernière prestation"
import "./style.scss";
    ...
    <>
      ...
      <footer className="row">
        <div className="col presta">
          ...
          {!lastEvent ? ( // Vérification si un dernier événement existe
            "Waiting last event..."
          ) : (
            <Modal // Affichage du dernier événement dans une modal
              key={lastEvent.id}
